...
__name(isLetDeclaration, "isLetDeclaration");
...
__name(hasSkipHydrationAttrOnTNode, "hasSkipHydrationAttrOnTNode");
function hasSkipHydrationAttrOnRElement(rNode) {
  return rNode.hasAttribute(SKIP_HYDRATION_ATTR_NAME);
}
__name(hasSkipHydrationAttrOnRElement, "hasSkipHydrationAttrOnRElement");
...
__name(isInSkipHydrationBlock2, "isInSkipHydrationBlock");
...
__name(isI18nInSkipHydrationBlock, "isI18nInSkipHydrationBlock");
...
__name(discoverLocalRefs, "discoverLocalRefs");
...
__name(getInjectionTokens, "getInjectionTokens");
...
__name(isDirectiveDefHack, "isDirectiveDefHack");
...
__name(setJSActionAttributes, "setJSActionAttributes");
var sharedStashFunction = /* @__PURE__ */ __name((rEl, eventType, listenerFn) => {
  const el = rEl;
...
var sharedMapFunction = /* @__PURE__ */ __name((rEl, jsActionMap) => {
  const el = rEl;
...
__name(removeListenersFromBlocks, "removeListenersFromBlocks");
var removeListeners = /* @__PURE__ */ __name((el) => {
...
function enableStashEventListenerImpl() {
  if (!isStashEventListenerImplEnabled) {
    _stashEventListenerImpl = /* @__PURE__ */ __name((lView, target, eventName, wrappedListener) => {
...
__name(enableStashEventListenerImpl, "enableStashEventListenerImpl");
...
__name(_DehydratedBlockRegistry, "DehydratedBlockRegistry");
/** @nocollapse */
__publicField(
  ...
  ɵɵdefineInjectable({
    ...
    providedIn: null,
    factory: /* @__PURE__ */ __name(() => new _DehydratedBlockRegistry(), "factory")
  })
);
...
__name(retrieveHydrationInfoImpl, "retrieveHydrationInfoImpl");
function enableRetrieveHydrationInfoImpl() {
  _retrieveHydrationInfoImpl = retrieveHydrationInfoImpl;
}
__name(enableRetrieveHydrationInfoImpl, "enableRetrieveHydrationInfoImpl");
...
__name(getTextNodeContent, "getTextNodeContent");
...
__name(processTextNodeMarkersBeforeHydration, "processTextNodeMarkersBeforeHydration");
var HydrationStatus;
...
__name(readHydrationInfo, "readHydrationInfo");
...
__name(markRNodeAsClaimedByHydration, "markRNodeAsClaimedByHydration");
...
__name(markRNodeAsSkippedByHydration, "markRNodeAsSkippedByHydration");
...
__name(countBlocksSkippedByHydration, "countBlocksSkippedByHydration");
...
__name(isRNodeClaimedForHydration, "isRNodeClaimedForHydration");
function setSegmentHead(hydrationInfo, index, node) {
  hydrationInfo.segmentHeads ??= {};
  hydrationInfo.segmentHeads[index] = node;
}
__name(setSegmentHead, "setSegmentHead");
function getSegmentHead(hydrationInfo, index) {
  return hydrationInfo.segmentHeads?.[index] ?? null;
}
__name(getSegmentHead, "getSegmentHead");
...
__name(calcSerializedContainerSize, "calcSerializedContainerSize");
...
__name(initDisconnectedNodes, "initDisconnectedNodes");
...
__name(isDisconnectedNode$1, "isDisconnectedNode$1");
...
__name(processTextNodeBeforeSerialization, "processTextNodeBeforeSerialization");
...
__name(convertHydrateTriggersToJsAction, "convertHydrateTriggersToJsAction");
...
__name(gatherDeferBlocksByJSActionAttribute, "gatherDeferBlocksByJSActionAttribute");
...
__name(appendDeferBlocksToJSActionMap, "appendDeferBlocksToJSActionMap");
var _retrieveDeferBlockDataImpl = /* @__PURE__ */ __name(() => {
  return {};
...
__name(retrieveDeferBlockDataImpl, "retrieveDeferBlockDataImpl");
function enableRetrieveDeferBlockDataImpl() {
  _retrieveDeferBlockDataImpl = retrieveDeferBlockDataImpl;
}
__name(enableRetrieveDeferBlockDataImpl, "enableRetrieveDeferBlockDataImpl");
function retrieveDeferBlockData(injector) {
  return _retrieveDeferBlockDataImpl(injector);
}
__name(retrieveDeferBlockData, "retrieveDeferBlockData");
...
__name(createBlockSummary, "createBlockSummary");
...
__name(processBlockData, "processBlockData");
...
__name(isSsrContentsIntegrity, "isSsrContentsIntegrity");
...
__name(skipTextNodes, "skipTextNodes");
...
__name(verifySsrContentsIntegrity, "verifySsrContentsIntegrity");
...
__name(provideNgReflectAttributes, "provideNgReflectAttributes");
...
__name(ɵsetUnknownElementStrictMode, "ɵsetUnknownElementStrictMode");
function ɵgetUnknownElementStrictMode() {
  return shouldThrowErrorOnUnknownElement;
}
__name(ɵgetUnknownElementStrictMode, "ɵgetUnknownElementStrictMode");
var shouldThrowErrorOnUnknownProperty = false;
function ɵsetUnknownPropertyStrictMode(shouldThrow) {
  shouldThrowErrorOnUnknownProperty = shouldThrow;
}
__name(ɵsetUnknownPropertyStrictMode, "ɵsetUnknownPropertyStrictMode");
function ɵgetUnknownPropertyStrictMode() {
  return shouldThrowErrorOnUnknownProperty;
}
__name(ɵgetUnknownPropertyStrictMode, "ɵgetUnknownPropertyStrictMode");
...
__name(clearElementContents, "clearElementContents");
...
__name(applyRootElementTransformImpl, "applyRootElementTransformImpl");
function enableApplyRootElementTransformImpl() {
  _applyRootElementTransformImpl = applyRootElementTransformImpl;
}
__name(enableApplyRootElementTransformImpl, "enableApplyRootElementTransformImpl");
...
__name(setDirectiveInput, "setDirectiveInput");
...
__name(isViewDirty, "isViewDirty");
function markForRefresh(view) {
  markViewForRefresh(view._lView);
}
__name(markForRefresh, "markForRefresh");
...
__name(validateMatchingNode, "validateMatchingNode");
...
__name(nodeNotFoundError, "nodeNotFoundError");
...
__name(nodeNotFoundAtPathError, "nodeNotFoundAtPathError");
...
__name(unsupportedProjectionOfDomNodes, "unsupportedProjectionOfDomNodes");
...
__name(invalidSkipHydrationHost, "invalidSkipHydrationHost");
...
__name(shortRNodeDescription, "shortRNodeDescription");
...
__name(getHydrationAttributeNote, "getHydrationAttributeNote");
...
__name(createIcuIterator, "createIcuIterator");
...
__name(compressNodeLocation, "compressNodeLocation");
...
__name(decompressNodeLocation, "decompressNodeLocation");
function isFirstElementInNgContainer(tNode) {
  return !tNode.prev && tNode.parent?.type === 8;
}
__name(isFirstElementInNgContainer, "isFirstElementInNgContainer");
function getNoOffsetIndex(tNode) {
  return tNode.index - HEADER_OFFSET;
}
__name(getNoOffsetIndex, "getNoOffsetIndex");
function isDisconnectedNode(tNode, lView) {
  return !(tNode.type & (16 | 128)) && !!lView[tNode.index] && isDisconnectedRNode(unwrapRNode(lView[tNode.index]));
}
__name(isDisconnectedNode, "isDisconnectedNode");
function isDisconnectedRNode(rNode) {
  return !!rNode && !rNode.isConnected;
}
__name(isDisconnectedRNode, "isDisconnectedRNode");
...
__name(locateI18nRNodeByIndex, "locateI18nRNodeByIndex");
...
__name(tryLocateRNodeByPath, "tryLocateRNodeByPath");
...
__name(siblingAfter, "siblingAfter");
...
__name(navigateToNode, "navigateToNode");
...
__name(locateRNodeByPath, "locateRNodeByPath");
...
__name(navigateBetween, "navigateBetween");
...
__name(calcPathForNode, "calcPathForNode");
...
__name(setIsI18nHydrationSupportEnabled, "setIsI18nHydrationSupportEnabled");
function isI18nHydrationSupportEnabled() {
  return _isI18nHydrationSupportEnabled;
}
__name(isI18nHydrationSupportEnabled, "isI18nHydrationSupportEnabled");
...
__name(enablePrepareI18nBlockForHydrationImpl, "enablePrepareI18nBlockForHydrationImpl");
...
__name(getOrComputeI18nChildren, "getOrComputeI18nChildren");
function collectI18nChildren(tView) {
  ...
  __name(collectI18nViews, "collectI18nViews");
  for (let i = HEADER_OFFSET; i < tView.bindingStartIndex; i++) {
...
__name(serializeI18nBlock, "serializeI18nBlock");
...
__name(serializeI18nNode, "serializeI18nNode");
...
__name(getFirstNativeNodeForI18nNode, "getFirstNativeNodeForI18nNode");
...
__name(appendI18nNodeToCollection, "appendI18nNodeToCollection");
...
function prepareI18nBlockForHydrationImpl(lView, index, parentTNode, subTemplateIndex) {
  ...
  __name(findHydrationRoot, "findHydrationRoot");
...
__name(collectI18nNodesFromDom, "collectI18nNodesFromDom");
...
__name(enableClaimDehydratedIcuCaseImpl, "enableClaimDehydratedIcuCaseImpl");
...
__name(claimDehydratedIcuCaseImpl, "claimDehydratedIcuCaseImpl");
...
__name(locateDehydratedViewsInContainer, "locateDehydratedViewsInContainer");
...
__name(enableFindMatchingDehydratedViewImpl, "enableFindMatchingDehydratedViewImpl");
...
__name(findMatchingDehydratedViewImpl, "findMatchingDehydratedViewImpl");
...
__name(findAndReconcileMatchingDehydratedViewsImpl, "findAndReconcileMatchingDehydratedViewsImpl");
...
__name(removeStaleDehydratedBranch, "removeStaleDehydratedBranch");
...
__name(hasMatchingDehydratedView, "hasMatchingDehydratedView");
...
__name(cleanupMatchingDehydratedViews, "cleanupMatchingDehydratedViews");
var _a;
...
__name(createOutputListener, "createOutputListener");
...
__name(listenToDirectiveOutput, "listenToDirectiveOutput");
...
__name(inputBindingUpdate, "inputBindingUpdate");
function inputBinding(publicName, value) {
  const binding = {
    [BINDING]: INPUT_BINDING_METADATA,
    update: /* @__PURE__ */ __name(() => inputBindingUpdate(binding.targetIdx, publicName, value()), "update")
  };
  return binding;
}
...
__name(outputBinding, "outputBinding");
...
__name(twoWayBinding, "twoWayBinding");
...
__name(populateDehydratedViewsInLContainerImpl, "populateDehydratedViewsInLContainerImpl");
function locateOrCreateAnchorNode(lContainer, hostLView, hostTNode, slotValue) {
  if (!_populateDehydratedViewsInLContainer(lContainer, hostTNode, hostLView)) {
    createAnchorNode(lContainer, hostLView, hostTNode, slotValue);
  }
}
__name(locateOrCreateAnchorNode, "locateOrCreateAnchorNode");
function enableLocateOrCreateContainerRefImpl() {
  _locateOrCreateAnchorNode = locateOrCreateAnchorNode;
  _populateDehydratedViewsInLContainer = populateDehydratedViewsInLContainerImpl;
}
__name(enableLocateOrCreateContainerRefImpl, "enableLocateOrCreateContainerRefImpl");
...
__name(isComponentDefPendingResolution, "isComponentDefPendingResolution");
...
__name(getRegisteredNgModuleType, "getRegisteredNgModuleType");
function setAllowDuplicateNgModuleIdsForTest(allowDuplicates) {
  checkForDuplicateNgModules = !allowDuplicates;
}
__name(setAllowDuplicateNgModuleIdsForTest, "setAllowDuplicateNgModuleIdsForTest");
...
__name(locateOrCreateContainerAnchorImpl, "locateOrCreateContainerAnchorImpl");
function enableLocateOrCreateContainerAnchorImpl() {
  _locateOrCreateContainerAnchor = locateOrCreateContainerAnchorImpl;
}
__name(enableLocateOrCreateContainerAnchorImpl, "enableLocateOrCreateContainerAnchorImpl");
...
__name(isDeferBlock, "isDeferBlock");
...
__name(getAsyncClassMetadataFn, "getAsyncClassMetadataFn");
...
__name(setClassMetadataAsync, "setClassMetadataAsync");
...
__publicField(_Console, "ɵprov", ɵɵdefineInjectable({ token: _Console, factory: _Console.ɵfac, providedIn: "platform" }));
...
__name(publishExternalGlobalUtil, "publishExternalGlobalUtil");
...
__publicField(_Testability, "ɵprov", ɵɵdefineInjectable({ token: _Testability, factory: _Testability.ɵfac }));
...
__publicField(_TestabilityRegistry, "ɵprov", ɵɵdefineInjectable({ token: _TestabilityRegistry, factory: _TestabilityRegistry.ɵfac, providedIn: "platform" }));
...
__publicField(_ApplicationInitStatus, "ɵprov", ɵɵdefineInjectable({ token: _ApplicationInitStatus, factory: _ApplicationInitStatus.ɵfac, providedIn: "root" }));
...
var _NgProbeToken = class _NgProbeToken {
  name;
  token;
...
__name(_NgProbeToken, "NgProbeToken");
var NgProbeToken = _NgProbeToken;
...
__publicField(_ApplicationRef, "ɵprov", ɵɵdefineInjectable({ token: _ApplicationRef, factory: _ApplicationRef.ɵfac, providedIn: "root" }));
...
__name(processAndInitTriggers, "processAndInitTriggers");
function setIdleTriggers(injector, elementTriggers) {
  for (const elementTrigger of elementTriggers) {
    ...
    const onInvoke = /* @__PURE__ */ __name(() => triggerHydrationFromBlockName(injector, elementTrigger.blockName), "onInvoke");
    const cleanupFn = onIdle(onInvoke, injector);
    registry.addCleanupFn(elementTrigger.blockName, cleanupFn);
  }
}
__name(setIdleTriggers, "setIdleTriggers");
...
__name(setViewportTriggers, "setViewportTriggers");
...
__name(logHmrWarning, "logHmrWarning");
...
__name(locateOrCreateElementNodeImpl, "locateOrCreateElementNodeImpl");
...
__name(locateOrCreateElementContainerNode, "locateOrCreateElementContainerNode");
...
__name(registerLocaleData, "registerLocaleData");
...
__name(getLocaleCurrencyCode, "getLocaleCurrencyCode");
...
__name(unregisterAllLocaleData, "unregisterAllLocaleData");
var LocaleDataIndex;
...
__name(locateOrCreateNodeImpl, "locateOrCreateNodeImpl");
function enableLocateOrCreateI18nNodeImpl() {
  _locateOrCreateNode = locateOrCreateNodeImpl;
}
__name(enableLocateOrCreateI18nNodeImpl, "enableLocateOrCreateI18nNodeImpl");
...
__name(locateOrCreateTextNodeImpl, "locateOrCreateTextNodeImpl");
function enableLocateOrCreateTextNodeImpl() {
  _locateOrCreateTextNode = locateOrCreateTextNodeImpl;
}
__name(enableLocateOrCreateTextNodeImpl, "enableLocateOrCreateTextNodeImpl");
...
__name(resetJitOptions, "resetJitOptions");
var moduleQueue = [];
...
__name(resetCompiledComponents, "resetCompiledComponents");
...
__publicField(_Compiler, "ɵprov", ɵɵdefineInjectable({ token: _Compiler, factory: _Compiler.ɵfac, providedIn: "root" }));
...
var _CompilerFactory = class _CompilerFactory {
};
__name(_CompilerFactory, "CompilerFactory");
var CompilerFactory = _CompilerFactory;
...
__publicField(_NgZoneChangeDetectionScheduler, "ɵprov", ɵɵdefineInjectable({ token: _NgZoneChangeDetectionScheduler, factory: _NgZoneChangeDetectionScheduler.ɵfac, providedIn: "root" }));
...
__publicField(_ZoneStablePendingTask, "ɵprov", ɵɵdefineInjectable({ token: _ZoneStablePendingTask, factory: _ZoneStablePendingTask.ɵfac, providedIn: "root" }));
...
__publicField(_ChangeDetectionSchedulerImpl, "ɵprov", ɵɵdefineInjectable({ token: _ChangeDetectionSchedulerImpl, factory: _ChangeDetectionSchedulerImpl.ɵfac, providedIn: "root" }));
...
__name(provideZonelessChangeDetection, "provideZonelessChangeDetection");
...
var LOCALE_ID = new InjectionToken(ngDevMode ? "LocaleId" : "", {
  providedIn: "root",
  factory: /* @__PURE__ */ __name(() => inject(LOCALE_ID, { optional: true, skipSelf: true }) || getGlobalLocale(), "factory")
});
...
var _DebugEventListener = class _DebugEventListener {
  name;
  callback;
...
__name(_DebugEventListener, "DebugEventListener");
var DebugEventListener = _DebugEventListener;
function asNativeElements(debugEls) {
  return debugEls.map((el) => el.nativeElement);
}
__name(asNativeElements, "asNativeElements");
var _DebugNode = class _DebugNode {
  /**
...
__name(_DebugNode, "DebugNode");
var DebugNode = _DebugNode;
var _DebugElement = class _DebugElement extends DebugNode {
  constructor(nativeNode) {
...
__name(_DebugElement, "DebugElement");
var DebugElement = _DebugElement;
...
__name(copyDomProperties, "copyDomProperties");
...
__name(_queryNodeChildren, "_queryNodeChildren");
...
__name(_queryNodeChildrenInContainer, "_queryNodeChildrenInContainer");
...
__name(_addQueryMatch, "_addQueryMatch");
...
__name(_queryNativeNodeDescendants, "_queryNativeNodeDescendants");
...
__name(collectPropertyBindings, "collectPropertyBindings");
...
__name(getDebugNode, "getDebugNode");
...
var isCaptureEventType = /* @__PURE__ */ __name((eventType) => CAPTURE_EVENT_TYPES.indexOf(eventType) >= 0, "isCaptureEventType");
var EARLY_EVENT_TYPES = BUBBLE_EVENT_TYPES.concat(CAPTURE_EVENT_TYPES);
var isEarlyEventType = /* @__PURE__ */ __name((eventType) => EARLY_EVENT_TYPES.indexOf(eventType) >= 0, "isEarlyEventType");
...
__name(getBrowserEventType, "getBrowserEventType");
...
__name(isMiddleClick, "isMiddleClick");
...
__name(isModifiedClickEvent, "isModifiedClickEvent");
...
__name(isMouseSpecialEvent, "isMouseSpecialEvent");
...
__name(createMouseSpecialEvent, "createMouseSpecialEvent");
var isIos = typeof navigator !== "undefined" && /iPhone|iPad|iPod/.test(navigator.userAgent);
var _EventContractContainer = class _EventContractContainer {
  element;
  /**
...
__name(_EventContractContainer, "EventContractContainer");
var EventContractContainer = _EventContractContainer;
var Char = {
  /**
...
__name(setEventType, "setEventType");
...
__name(setTargetElement, "setTargetElement");
...
__name(setContainer, "setContainer");
...
__name(setTimestamp, "setTimestamp");
...
__name(setAction, "setAction");
function unsetAction(eventInfo) {
  eventInfo.eia = void 0;
}
__name(unsetAction, "unsetAction");
function getActionElement(actionInfo) {
  return actionInfo[1];
}
__name(getActionElement, "getActionElement");
function getIsReplay(eventInfo) {
  return eventInfo.eirp;
}
__name(getIsReplay, "getIsReplay");
function setIsReplay(eventInfo, replay) {
  eventInfo.eirp = replay;
}
__name(setIsReplay, "setIsReplay");
...
__name(cloneEventInfo, "cloneEventInfo");
...
__name(createEventInfoFromParameters, "createEventInfoFromParameters");
var _EventInfoWrapper = class _EventInfoWrapper {
  eventInfo;
...
__name(_EventInfoWrapper, "EventInfoWrapper");
var EventInfoWrapper = _EventInfoWrapper;
var EMPTY_ACTION_MAP = {};
var REGEXP_SEMICOLON = /\s*;\s*/;
var DEFAULT_EVENT_TYPE = EventType.CLICK;
var _ActionResolver = class _ActionResolver {
...
__name(shouldPreventDefaultBeforeDispatching, "shouldPreventDefaultBeforeDispatching");
...
__name(prepareEventForBubbling, "prepareEventForBubbling");
function propagationStopped(eventInfoWrapper) {
  const event = eventInfoWrapper.getEvent();
  return !!event[PROPAGATION_STOPPED_SYMBOL];
}
__name(propagationStopped, "propagationStopped");
...
__name(prepareEventForReplay, "prepareEventForReplay");
...
__name(prepareEventForDispatch, "prepareEventForDispatch");
...
__name(patchEventInstance, "patchEventInstance");
function registerDispatcher$1(eventContract, dispatcher) {
  eventContract.ecrd((eventInfo) => {
    dispatcher.dispatch(eventInfo);
  }, Restriction.I_AM_THE_JSACTION_FRAMEWORK);
}
__name(registerDispatcher$1, "registerDispatcher$1");
function getQueuedEventInfos(earlyJsactionData) {
  return earlyJsactionData?.q ?? [];
}
__name(getQueuedEventInfos, "getQueuedEventInfos");
...
__name(removeAllEventListeners, "removeAllEventListeners");
...
var _EventContract = class _EventContract {
  ...
  addEvent(eventType, prefixedEventType, passive) {
    ...
    const eventHandler = /* @__PURE__ */ __name((eventType2, event, container) => {
...
__name(_EventContract, "EventContract");
...
__name(getAppScopedQueuedEventInfos, "getAppScopedQueuedEventInfos");
...
__name(clearAppScopedEarlyEventContract, "clearAppScopedEarlyEventContract");
...
__name(viewChildren, "viewChildren");
...
__publicField(_ImagePerformanceWarning, "ɵprov", ɵɵdefineInjectable({ token: _ImagePerformanceWarning, factory: _ImagePerformanceWarning.ɵfac, providedIn: "root" }));
...
__publicField(_PlatformRef, "ɵprov", ɵɵdefineInjectable({ token: _PlatformRef, factory: _PlatformRef.ɵfac, providedIn: "platform" }));
...
__name(destroyPlatform, "destroyPlatform");
...
__name(providePlatformInitializer, "providePlatformInitializer");
...
__name(exhaustiveCheckNoChangesInterval, "exhaustiveCheckNoChangesInterval");
...
__name(provideCheckNoChangesConfig, "provideCheckNoChangesConfig");
function isDevMode() {
...
__name(enableProdMode, "enableProdMode");
...
__name(getModuleFactory, "getModuleFactory");
...
__name(getNgModuleById, "getNgModuleById");
function noModuleError(id) {
  return new Error(`No module with ID ${id} loaded`);
}
__name(noModuleError, "noModuleError");
...
var _ViewRef2 = class _ViewRef2 extends ChangeDetectorRef {
};
__name(_ViewRef2, "ViewRef");
var ViewRef2 = _ViewRef2;
var _EmbeddedViewRef = class _EmbeddedViewRef extends ViewRef2 {
};
__name(_EmbeddedViewRef, "EmbeddedViewRef");
var EmbeddedViewRef = _EmbeddedViewRef;
...
__publicField(_ApplicationModule, "ɵmod", ɵɵdefineNgModule({ type: _ApplicationModule }));
...
__name(shouldEnableEventReplay, "shouldEnableEventReplay");
...
__name(withEventReplay, "withEventReplay");
var initEventReplay = /* @__PURE__ */ __name((eventDelegation, injector) => {
  const appId = injector.get(APP_ID);
...
__name(collectDomEventsInfo, "collectDomEventsInfo");
...
__name(invokeRegisteredReplayListeners, "invokeRegisteredReplayListeners");
...
__name(replayQueuedBlockEvents, "replayQueuedBlockEvents");
var _SerializedViewCollection = class _SerializedViewCollection {
  views = [];
...
__name(_SerializedViewCollection, "SerializedViewCollection");
var SerializedViewCollection = _SerializedViewCollection;
var tViewSsrId = 0;
...
__name(getSsrId, "getSsrId");
function calcNumRootNodes(tView, lView, tNode) {
  const rootNodes = [];
  collectNativeNodes(tView, lView, tNode, rootNodes);
  return rootNodes.length;
}
__name(calcNumRootNodes, "calcNumRootNodes");
...
__name(annotateLContainerForHydration, "annotateLContainerForHydration");
...
__name(serializeLContainer, "serializeLContainer");
...
__name(serializeHydrateTriggers, "serializeHydrateTriggers");
...
__name(appendSerializedNodePath, "appendSerializedNodePath");
...
__name(serializeLView, "serializeLView");
...
__name(conditionallyAnnotateNodePath, "conditionallyAnnotateNodePath");
...
__name(annotateHostElementForHydration, "annotateHostElementForHydration");
function annotateDeferBlockAnchorForHydration(comment, deferBlockId) {
  comment.textContent = `ngh=${deferBlockId}`;
}
__name(annotateDeferBlockAnchorForHydration, "annotateDeferBlockAnchorForHydration");
function insertCorruptedTextNodeMarkers(corruptedTextNodes, doc) {
  for (const [textNode, marker] of corruptedTextNodes) {
    textNode.after(doc.createComment(marker));
  }
}
__name(insertCorruptedTextNodeMarkers, "insertCorruptedTextNodeMarkers");
...
__name(annotateDeferBlockRootNodesWithJsAction, "annotateDeferBlockRootNodesWithJsAction");
...
__name(enableHydrationRuntimeSupport, "enableHydrationRuntimeSupport");
...
__name(enableI18nHydrationRuntimeSupport, "enableI18nHydrationRuntimeSupport");
...
__name(enableIncrementalHydrationRuntimeSupport, "enableIncrementalHydrationRuntimeSupport");
...
__name(printHydrationStats, "printHydrationStats");
...
__name(withDomHydration, "withDomHydration");
function withI18nSupport() {
  return [
    {
      provide: IS_I18N_HYDRATION_ENABLED,
      useFactory: /* @__PURE__ */ __name(() => inject(IS_HYDRATION_DOM_REUSE_ENABLED), "useFactory")
    },
    {
      provide: ENVIRONMENT_INITIALIZER,
      useValue: /* @__PURE__ */ __name(() => {
...
__name(withI18nSupport, "withI18nSupport");
...
__name(withIncrementalHydration, "withIncrementalHydration");
...
__name(logWarningOnStableTimedout, "logWarningOnStableTimedout");
...
__name(startMeasuring, "startMeasuring");
...
__name(stopMeasuring, "stopMeasuring");
...
__name(enableProfiling2, "enableProfiling");
function disableProfiling() {
  enablePerfLogging = false;
}
__name(disableProfiling, "disableProfiling");
...
__name(getClosestComponentName, "getClosestComponentName");
function ɵassertType(value) {
}
__name(ɵassertType, "ɵassertType");
...
__name(ɵɵngDeclareDirective, "ɵɵngDeclareDirective");
function ɵɵngDeclareClassMetadata(decl) {
  setClassMetadata(decl.type, decl.decorators, decl.ctorParameters ?? null, decl.propDecorators ?? null);
}
__name(ɵɵngDeclareClassMetadata, "ɵɵngDeclareClassMetadata");
...
__name(ɵɵngDeclareClassMetadataAsync, "ɵɵngDeclareClassMetadataAsync");
...
__name(ɵɵngDeclareComponent, "ɵɵngDeclareComponent");
...
__name(ɵɵngDeclareFactory, "ɵɵngDeclareFactory");
...
__name(getFactoryKind, "getFactoryKind");
...
__name(ɵɵngDeclareInjectable, "ɵɵngDeclareInjectable");
...
__name(ɵɵngDeclareInjector, "ɵɵngDeclareInjector");
...
__name(ɵɵngDeclareNgModule, "ɵɵngDeclareNgModule");
...
__name(ɵɵngDeclarePipe, "ɵɵngDeclarePipe");
...
var _AfterRenderEffectSequence = class _AfterRenderEffectSequence extends AfterRenderSequence {
  scheduler;
  /**
...
__name(_AfterRenderEffectSequence, "AfterRenderEffectSequence");
var AfterRenderEffectSequence = _AfterRenderEffectSequence;
...
__name(afterRenderEffect, "afterRenderEffect");
...
__name(setupDebugInfo, "setupDebugInfo");
...
__name(phaseDebugName, "phaseDebugName");
...
__name(mergeApplicationConfig, "mergeApplicationConfig");
...
@angular/core/fesm2022/debug_node.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-424NGYFU.js.map
